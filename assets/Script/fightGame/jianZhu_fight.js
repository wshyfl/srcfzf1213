cc.Class({
    ...
    onInitTween() {
        ...
        this._shade.zIndex = this._y - 150;
        ...
        this.shadeTween = cc.tween(this._shade)
            ...
            .start()
        if (this.node.type == 0) {
            var randomRang = [-475, -110]
        }
        else {
            var randomRang = [104, 460]
        }
        this.node.x = Tools.random(randomRang[0], randomRang[1]);
    ...
    update(dt) {
        this.node.zIndex = this.node.y - 80;
